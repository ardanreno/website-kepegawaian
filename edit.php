...
<div class="container">
    ...
    if (isset($_POST['update'])) {
        ...
        if (
            empty($_POST['nama']) || empty($_POST['posisi']) ||
            ...
            $sql = "UPDATE users SET nama='{$nama}', posisi='{$posisi}',
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="box">
                ...
                <form action="" method="POST">
                    ...
                    <label for="posisi">Posisi/Staff</label>
                    <input type="text" id="posisi" name="posisi" value="<?php echo $row['posisi']; ?>" class="form-control"><br>
